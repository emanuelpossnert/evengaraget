    ...
    try {
      ...
      const dailyStats = daysInMonth.map((day) => {
        ...
        return {
          ...
          revenue: dayBookings.reduce((sum, b) => sum + (b.total_amount || 0), 0) / 1000,
        };
      });
      ...
      for (let i = 11; i >= 0; i--) {
        ...
        weeklyStats.push({
          ...
          revenue: weekBks.reduce((sum, b) => sum + (b.total_amount || 0), 0) / 1000,
        });
      }
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <div className="bg-gradient-to-br from-purple-50 to-purple-100 rounded-lg p-6 border border-purple-200">
          ...
          <p className="text-3xl font-bold text-purple-900 mt-2">
            {(totalStats.totalRevenue / 1000).toLocaleString("sv-SE")}k SEK
          </p>
        ...
        >
          <div className="flex items-start justify-between mb-4">
            <div>
              ...
              <p className="text-orange-700 text-sm mt-1">Nya bokningar väntar</p>
            </div>
            <AlertCircle className="text-orange-600" size={28} />
          </div>
          <div className="text-4xl font-bold text-orange-900">{totalStats.pendingReview}</div>
        </div>
        ...
        >
          <div className="flex items-start justify-between mb-4">
            <div>
              ...
              <p className="text-yellow-700 text-sm mt-1">Redo för bekräftelse</p>
            </div>
            <Calendar className="text-yellow-600" size={28} />
          </div>
          <div className="text-4xl font-bold text-yellow-900">{totalStats.pendingConfirmation}</div>
        </div>
      </div>
            ...
            {newBookings.length === 0 ? (
              ...
              newBookings.map((booking) => (
                ...
                >
                  ...
                  <p className="text-xs text-gray-600 mt-1">{booking.customer_name}</p>
            ...
            {upcomingDeliveries.length === 0 ? (
              ...
              upcomingDeliveries.map((delivery) => (
                ...
                >
                  ...
                  <p className="text-xs text-gray-600 mt-1">{delivery.customer_name}</p>
                  <div className="flex justify-between items-center mt-2">
